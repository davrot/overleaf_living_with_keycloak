...
pug_html = pug_html + "\u003Cmeta" + (" name=\"ol-bootstrapVersion\" data-type=\"json\""+pug.attr("content", bootstrapVersion, true, true)) + "\u003E\u003Cmeta" + (" name=\"ol-postUrl\" data-type=\"string\""+pug.attr("content", postUrl, true, true)) + "\u003E\u003Cmeta" + (" name=\"ol-user\" data-type=\"json\""+pug.attr("content", user, true, true)) + "\u003E\u003C\u002Fhead\u003E\u003Cbody" + (pug.attr("class", pug.classes([{
...
pug_html = pug_html + "\u003Cdiv class=\"content content-alt\" id=\"main-content\"\u003E\u003Cdiv id=\"token-access-page\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
...
pug_html = pug_html + "\u003Cscript" + (" type=\"text\u002Fjavascript\""+pug.attr("nonce", scriptNonce, true, true)) + "\u003Ewindow.addEventListener('DOMContentLoaded', function() {\n\t\u002F\u002F- Look for bundle\n\tvar cdnBlocked = typeof Frontend === 'undefined'\n\t\u002F\u002F- Prevent loops\n\tvar noCdnAlreadyInUrl = window.location.href.indexOf(\"nocdn=true\") != -1\n\tif (cdnBlocked && !noCdnAlreadyInUrl && navigator.userAgent.indexOf(\"Googlebot\") == -1) {\n\t\t\u002F\u002F- Set query param, server will not set CDN url\n\t\twindow.location.search += \"&nocdn=true\";\n\t}\n})\u003C\u002Fscript\u003E\u003C\u002Fhtml\u003E";
        ...
        locals_for_with.nav :
        typeof nav !== 'undefined' ? nav : undefined, "postUrl" in locals_for_with ?
        locals_for_with.postUrl :
        typeof postUrl !== 'undefined' ? postUrl : undefined, "projectDashboardReact" in locals_for_with ?
