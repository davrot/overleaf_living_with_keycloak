...
pug_html = pug_html + "\u003Cmain class=\"content content-alt\" id=\"main-content\"\u003E\u003Cdiv class=\"container\"\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4\"\u003E\u003Cdiv class=\"card\"\u003E\u003Cdiv class=\"page-header\"\u003E\u003Ch1\u003E" + (pug.escape(null == (pug_interp = translate("log_in")) ? "" : pug_interp)) + "\u003C\u002Fh1\u003E\u003C\u002Fdiv\u003E\u003Cform data-ol-async-form name=\"loginForm\" action=\"\u002Flogin\" method=\"POST\"\u003E\u003Cinput" + (" name=\"_csrf\" type=\"hidden\""+pug.attr("value", csrfToken, true, true)) + "\u003E";
pug_mixins["formMessages"]();
pug_mixins["customFormMessage"].call({
block: function(){
pug_html = pug_html + (null == (pug_interp = translate('email_or_password_wrong_try_again_or_reset', {}, [{ name: 'a', attrs: { href: '/user/password/reset', 'aria-describedby': 'resetPasswordDescription' } }])) ? "" : pug_interp) + "\u003Cspan class=\"sr-only\" id=\"resetPasswordDescription\"\u003E" + (pug.escape(null == (pug_interp = translate('reset_password_link')) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
}, 'invalid-password-retry-or-reset', 'danger');
pug_mixins["customValidationMessage"].call({
block: function(){
pug_html = pug_html + (null == (pug_interp = translate('password_compromised_try_again_or_use_known_device_or_reset', {}, [{name: 'a', attrs: {href: 'https://haveibeenpwned.com/passwords', rel: 'noopener noreferrer', target: '_blank'}}, {name: 'a', attrs: {href: '/user/password/reset', target: '_blank'}}])) ? "" : pug_interp) + ".";
}
}, 'password-compromised');
pug_html = pug_html + "\u003Cdiv class=\"form-group\"\u003E\u003Cinput class=\"form-control\" type=\"email\" name=\"email\" required placeholder=\"email@example.com\" autofocus=\"true\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"form-group\"\u003E\u003Cinput class=\"form-control\" type=\"password\" name=\"password\" required placeholder=\"********\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"actions\"\u003E\u003Cbutton class=\"btn-primary btn\" type=\"submit\" data-ol-disabled-inflight\u003E\u003Cspan data-ol-inflight=\"idle\"\u003E" + (pug.escape(null == (pug_interp = translate("login")) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cspan hidden data-ol-inflight=\"pending\"\u003E" + (pug.escape(null == (pug_interp = translate("logging_in")) ? "" : pug_interp)) + "…\u003C\u002Fspan\u003E\u003C\u002Fbutton\u003E\u003Ca class=\"pull-right\" href=\"\u002Fuser\u002Fpassword\u002Freset\"\u003E" + (pug.escape(null == (pug_interp = translate("forgot_your_password")) ? "" : pug_interp)) + "?\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E\u003C\u002Fform\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fmain\u003E";
