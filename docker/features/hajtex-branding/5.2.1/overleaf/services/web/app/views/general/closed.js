...
pug_html = pug_html + "\u003Cmain class=\"content\" id=\"main-content\"\u003E\u003Cdiv class=\"container\"\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-md-8 col-md-offset-2 text-center\"\u003E\u003Cdiv class=\"page-header\"\u003E\u003Ch1\u003EMaintenance\u003C\u002Fh1\u003E\u003C\u002Fdiv\u003E\u003Cp\u003E";
if (settings.statusPageUrl) {
pug_html = pug_html + (pug.escape(null == (pug_interp = settings.appName) ? "" : pug_interp)) + " is currently down for maintenance.\nPlease check our \u003Ca" + (pug.attr("href", 'https://' + settings.statusPageUrl, true, true)) + "\u003Estatus page\u003C\u002Fa\u003E\nfor updates.";
}
else {
pug_html = pug_html + ((pug.escape(null == (pug_interp = settings.appName) ? "" : pug_interp)) + " is currently down for maintenance.\nWe should be back within minutes, but if not, or you have\nan urgent request, please contact us at\n&nbsp;" + (pug.escape(null == (pug_interp = settings.adminEmail) ? "" : pug_interp)));
}
pug_html = pug_html + "\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fmain\u003E";
