...
pug_html = pug_html + "\u003Cdiv class=\"content content-alt\" id=\"main-content\"\u003E\u003Cdiv class=\"container bonus\"\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-md-8 col-md-offset-2\"\u003E\u003Cdiv class=\"card\"\u003E\u003Cdiv class=\"container-fluid\"\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-md-10 col-md-offset-1\"\u003E";
if ((refered_user_count > 0)) {
pug_html = pug_html + "\u003Cp class=\"thanks\"\u003EThe Overleaf Bonus Program has been discontinued, but you'll continue to have access to the features you already earned.\u003C\u002Fp\u003E";
}
else {
pug_html = pug_html + "\u003Cp class=\"thanks\"\u003EThe Overleaf Bonus Program has been discontinued.\u003C\u002Fp\u003E";
}
pug_html = pug_html + "\u003Cp class=\"thanks\"\u003EPlease \u003Ca href=\"\u002Fcontact\"\u003Econtact us\u003C\u002Fa\u003E if you have any questions.\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
if ((refered_user_count > 0)) {
pug_html = pug_html + "\u003Cdiv class=\"row ab-bonus\"\u003E\u003Cdiv class=\"col-md-10 col-md-offset-1 bonus-banner\" style=\"position: relative; height: 30px; margin-top: 20px;\"\u003E";
for (var i = 0; i <= 10; i++) {
{
if ((refered_user_count == i)) {
pug_html = pug_html + "\u003Cdiv" + (" class=\"number active\""+pug.attr("style", pug.style("left: "+i+"0%"), true, true)) + "\u003E" + (pug.escape(null == (pug_interp = i) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E";
}
else {
pug_html = pug_html + "\u003Cdiv" + (" class=\"number\""+pug.attr("style", pug.style("left: "+i+"0%"), true, true)) + "\u003E" + (pug.escape(null == (pug_interp = i) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E";
}
}
}
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"row ab-bonus\"\u003E\u003Cdiv class=\"col-md-10 col-md-offset-1 bonus-banner\"\u003E\u003Cdiv class=\"progress\"\u003E\u003Cdiv" + (" class=\"progress-bar progress-bar-info\""+pug.attr("style", pug.style("width: "+refered_user_count+"0%"), true, true)) + "\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"row ab-bonus\"\u003E\u003Cdiv class=\"col-md-10 col-md-offset-1 bonus-banner\" style=\"position: relative; height: 110px;\"\u003E\u003Cdiv" + (pug.attr("class", pug.classes(["perk",refered_user_count >= 1 ? "active" : ""], [false,true]), false, true)+" style=\"left: 10%;\"") + "\u003E" + (pug.escape(null == (pug_interp = translate("one_free_collab")) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003Cdiv" + (pug.attr("class", pug.classes(["perk",refered_user_count >= 3 ? "active" : ""], [false,true]), false, true)+" style=\"left: 30%;\"") + "\u003E" + (pug.escape(null == (pug_interp = translate("three_free_collab")) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003Cdiv" + (pug.attr("class", pug.classes(["perk",refered_user_count >= 6 ? "active" : ""], [false,true]), false, true)+" style=\"left: 60%;\"") + "\u003E" + (pug.escape(null == (pug_interp = translate("free_dropbox_and_history")) ? "" : pug_interp)) + " + " + (pug.escape(null == (pug_interp = translate("three_free_collab")) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003Cdiv" + (pug.attr("class", pug.classes(["perk",refered_user_count >= 9 ? "active" : ""], [false,true]), false, true)+" style=\"left: 90%;\"") + "\u003E" + (pug.escape(null == (pug_interp = translate("free_dropbox_and_history")) ? "" : pug_interp)) + " + " + (pug.escape(null == (pug_interp = translate("unlimited_collabs")) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"row\"\u003E&nbsp;\u003C\u002Fdiv\u003E\u003Cdiv class=\"row ab-bonus\"\u003E\u003Cdiv class=\"col-md-10 col-md-offset-1 bonus-banner bonus-status\"\u003E";
if ((refered_user_count == 1)) {
pug_html = pug_html + "\u003Cp class=\"thanks\"\u003EYou’ve introduced \u003Cstrong\u003E1\u003C\u002Fstrong\u003E person to " + (pug.escape(null == (pug_interp = settings.appName) ? "" : pug_interp)) + ".\u003C\u002Fp\u003E";
}
else {
pug_html = pug_html + "\u003Cp class=\"thanks\"\u003EYou’ve introduced \u003Cstrong\u003E" + (pug.escape(null == (pug_interp = refered_user_count) ? "" : pug_interp)) + "\u003C\u002Fstrong\u003E people to " + (pug.escape(null == (pug_interp = settings.appName) ? "" : pug_interp)) + ".\u003C\u002Fp\u003E";
}
...
pug_html = pug_html + "\u003Cscript" + (" type=\"text\u002Fjavascript\""+pug.attr("nonce", scriptNonce, true, true)) + "\u003Ewindow.addEventListener('DOMContentLoaded', function() {\n\t\u002F\u002F- Look for bundle\n\tvar cdnBlocked = typeof Frontend === 'undefined'\n\t\u002F\u002F- Prevent loops\n\tvar noCdnAlreadyInUrl = window.location.href.indexOf(\"nocdn=true\") != -1\n\tif (cdnBlocked && !noCdnAlreadyInUrl && navigator.userAgent.indexOf(\"Googlebot\") == -1) {\n\t\t\u002F\u002F- Set query param, server will not set CDN url\n\t\twindow.location.search += \"&nocdn=true\";\n\t}\n})\u003C\u002Fscript\u003E\u003C\u002Fhtml\u003E";
        ...
        typeof hideFatFooter !== 'undefined' ? hideFatFooter : undefined, "i" in locals_for_with ?
        locals_for_with.i :
        typeof i !== 'undefined' ? i : undefined, "isManagedAccount" in locals_for_with ?
        ...
        typeof projectDashboardReact !== 'undefined' ? projectDashboardReact : undefined, "refered_user_count" in locals_for_with ?
        locals_for_with.refered_user_count :
        typeof refered_user_count !== 'undefined' ? refered_user_count : undefined, "scriptNonce" in locals_for_with ?
