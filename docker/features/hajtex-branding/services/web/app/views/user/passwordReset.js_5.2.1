var pug = require("pug-runtime");function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;
    ...
    (function (Date, ExposedSettings, Object, bootstrap5Override, brandVariation, buildBaseAssetPath, buildCssPath, buildImgPath, buildJsPath, canDisplayAdminMenu, canDisplayAdminRedirect, canDisplaySplitTestMenu, canDisplaySurveyMenu, canRedirectToAdminDomain, csrfToken, currentLngCode, currentUrl, currentUrlWithQueryParams, deferScripts, dictionariesRoot, enableUpgradeButton, entrypoint, entrypointScripts, entrypointStyles, error, fixedSizeDocument, getCssThemeModifier, getLoggedInUserId, getSessionAnalyticsId, getSessionUser, getUserEmail, hasAdminAccess, hasCustomLeftNav, hasFeature, hideFatFooter, isManagedAccount, mathJaxPath, metadata, moduleIncludes, nav, projectDashboardReact, scriptNonce, settings, showCaptcha, showLanguagePicker, showThinFooter, splitTestInfo, splitTestVariants, suppressCookieBanner, suppressFooter, suppressGoogleAnalytics, suppressNavContentLinks, suppressNavbar, suppressNavbarRight, suppressRelAlternateLinks, suppressSkipToContent, title, translate, user, userRestrictions, userSettings, usersBestSubscription) {
      pug_mixins["recaptchaConditions"] = pug_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv class=\"recaptcha-branding\"\u003E" + (null == (pug_interp = translate("recaptcha_conditions", {}, [{}, {name: 'a', attrs: {href: 'https://policies.google.com/privacy', rel: 'noopener noreferrer', target: '_blank'}}, {name: 'a', attrs: {href: 'https://policies.google.com/terms', rel: 'noopener noreferrer', target: '_blank'}}])) ? "" : pug_interp) + "\u003C\u002Fdiv\u003E";
};
...
if (showCaptcha) {
pug_html = pug_html + "\u003Cscript" + (" type=\"text\u002Fjavascript\""+pug.attr("nonce", scriptNonce, true, true)+" src=\"https:\u002F\u002Fwww.recaptcha.net\u002Frecaptcha\u002Fapi.js?render=explicit\"") + "\u003E\u003C\u002Fscript\u003E\u003Cdiv" + (" class=\"g-recaptcha\""+" id=\"recaptcha\""+pug.attr("data-sitekey", settings.recaptcha.siteKey, true, true)+" data-size=\"invisible\" data-badge=\"inline\"") + "\u003E\u003C\u002Fdiv\u003E";
}
pug_html = pug_html + "\u003Cmain class=\"content content-alt\" id=\"main-content\" data-ol-captcha-retry-trigger-area=\"\"\u003E\u003Cdiv class=\"container-custom-sm mx-auto\"\u003E\u003Cdiv class=\"card\"\u003E\u003Cform" + (pug.attr("data-ol-async-form", true, true, true)+" name=\"passwordResetForm\" action=\"\u002Fuser\u002Fpassword\u002Freset\" method=\"POST\""+pug.attr("captcha", (showCaptcha ? '' : false), true, true)+pug.attr("captcha-action-name", (showCaptcha ? "passwordReset" : false), true, true)) + "\u003E";
if (error === 'password_reset_token_expired') {
pug_html = pug_html + "\u003Ch3 class=\"mt-0 mb-2\"\u003E" + (pug.escape(null == (pug_interp = translate("sorry_your_token_expired")) ? "" : pug_interp)) + "\u003C\u002Fh3\u003E\u003Cp\u003E" + (pug.escape(null == (pug_interp = translate('please_request_a_new_password_reset_email_and_follow_the_link')) ? "" : pug_interp)) + ".\u003C\u002Fp\u003E";
}
else {
pug_html = pug_html + "\u003Ch3 class=\"mt-0 mb-2\" data-ol-not-sent\u003E" + (pug.escape(null == (pug_interp = translate("password_reset")) ? "" : pug_interp)) + "\u003C\u002Fh3\u003E\u003Ch3 class=\"mt-0 mb-2\" hidden data-ol-sent\u003E" + (pug.escape(null == (pug_interp = translate("check_your_email")) ? "" : pug_interp)) + "\t\u003C\u002Fh3\u003E\u003Cp data-ol-not-sent\u003E" + (pug.escape(null == (pug_interp = translate("enter_your_email_address_below_and_we_will_send_you_a_link_to_reset_your_password")) ? "" : pug_interp)) + ".\u003C\u002Fp\u003E";
}
pug_html = pug_html + "\u003Cdiv data-ol-not-sent\u003E";
pug_mixins["formMessages"]();
if (error && error !== 'password_reset_token_expired') {
pug_html = pug_html + "\u003Cdiv class=\"alert alert-danger mb-2\" role=\"alert\" aria-live=\"assertive\"\u003E" + (pug.escape(null == (pug_interp = translate(error)) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E";
}
pug_html = pug_html + "\u003Cdiv data-ol-custom-form-message=\"no-password-allowed-due-to-sso\" hidden\u003E\u003Cdiv class=\"notification notification-type-error\" aria-live=\"polite\" style=\"margin-bottom: 10px;\"\u003E\u003Cdiv class=\"notification-icon\"\u003E\u003Cspan class=\"material-symbols material-symbols-rounded\" aria-hidden=\"true\"\u003Eerror\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"notification-content-and-cta\"\u003E\u003Cdiv class=\"notification-content\"\u003E\u003Cp\u003E" + (null == (pug_interp = translate("you_cant_reset_password_due_to_sso", {}, [{name: 'a', attrs: {href: '/sso-login'}}])) ? "" : pug_interp) + "\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cinput" + (" type=\"hidden\" name=\"_csrf\""+pug.attr("value", csrfToken, true, true)) + "\u003E\u003Cdiv class=\"form-group mb-3\"\u003E\u003Clabel for=\"email\"\u003E" + (pug.escape(null == (pug_interp = translate("email")) ? "" : pug_interp)) + "\u003C\u002Flabel\u003E\u003Cinput" + (" class=\"form-control\""+" id=\"email\" aria-label=\"email\" type=\"email\" name=\"email\""+pug.attr("placeholder", translate("enter_your_email_address"), true, true)+pug.attr("required", true, true, true)+" autocomplete=\"username\""+pug.attr("autofocus", true, true, true)) + "\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"actions\"\u003E\u003Cbutton" + (" class=\"btn btn-primary w-100\""+" type=\"submit\""+pug.attr("data-ol-disabled-inflight", true, true, true)+pug.attr("aria-label", translate('request_password_reset_to_reconfirm'), true, true)) + "\u003E\u003Cspan data-ol-inflight=\"idle\"\u003E" + (pug.escape(null == (pug_interp = translate("request_password_reset")) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cspan hidden data-ol-inflight=\"pending\"\u003E" + (pug.escape(null == (pug_interp = translate("requesting_password_reset")) ? "" : pug_interp)) + "…\u003C\u002Fspan\u003E\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv hidden data-ol-sent\u003E\u003Cp class=\"mb-4\"\u003E" + (pug.escape(null == (pug_interp = translate('password_reset_email_sent')) ? "" : pug_interp)) + "\u003C\u002Fp\u003E\u003Ca href=\"\u002Flogin\"\u003E" + (pug.escape(null == (pug_interp = translate('back_to_log_in')) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E\u003C\u002Fform\u003E\u003C\u002Fdiv\u003E";
if (showCaptcha) {
pug_mixins["recaptchaConditions"]();
}
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fmain\u003E";
...
pug_html = pug_html + "\u003Cscript" + (" type=\"text\u002Fjavascript\""+pug.attr("nonce", scriptNonce, true, true)) + "\u003Ewindow.addEventListener('DOMContentLoaded', function() {\n\t\u002F\u002F- Look for bundle\n\tvar cdnBlocked = typeof Frontend === 'undefined'\n\t\u002F\u002F- Prevent loops\n\tvar noCdnAlreadyInUrl = window.location.href.indexOf(\"nocdn=true\") != -1\n\tif (cdnBlocked && !noCdnAlreadyInUrl && navigator.userAgent.indexOf(\"Googlebot\") == -1) {\n\t\t\u002F\u002F- Set query param, server will not set CDN url\n\t\twindow.location.search += \"&nocdn=true\";\n\t}\n})\u003C\u002Fscript\u003E\u003C\u002Fhtml\u003E";
        ...
        typeof entrypointStyles !== 'undefined' ? entrypointStyles : undefined, "error" in locals_for_with ?
        locals_for_with.error :
        typeof error !== 'undefined' ? error : undefined, "fixedSizeDocument" in locals_for_with ?
        ...
        typeof settings !== 'undefined' ? settings : undefined, "showCaptcha" in locals_for_with ?
        locals_for_with.showCaptcha :
        typeof showCaptcha !== 'undefined' ? showCaptcha : undefined, "showLanguagePicker" in locals_for_with ?
