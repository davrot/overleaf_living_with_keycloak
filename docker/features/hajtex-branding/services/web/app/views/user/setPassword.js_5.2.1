...
pug_mixins["customFormMessage"] = pug_interp = function(key, kind){
var block = (this && this.block), attributes = (this && this.attributes) || {};
if (kind === 'success') {
pug_html = pug_html + "\u003Cdiv" + (" class=\"alert alert-success\""+pug.attr("hidden", true, true, true)+pug.attr("data-ol-custom-form-message", key, true, true)+" role=\"alert\" aria-live=\"polite\"") + "\u003E";
block && block();
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
}
else
if (kind === 'danger') {
pug_html = pug_html + "\u003Cdiv" + (" class=\"alert alert-danger\""+pug.attr("hidden", true, true, true)+pug.attr("data-ol-custom-form-message", key, true, true)+" role=\"alert\" aria-live=\"assertive\"") + "\u003E";
block && block();
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
}
else {
pug_html = pug_html + "\u003Cdiv" + (" class=\"alert alert-warning\""+pug.attr("hidden", true, true, true)+pug.attr("data-ol-custom-form-message", key, true, true)+" role=\"alert\" aria-live=\"polite\"") + "\u003E";
block && block();
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
}
};
...
pug_mixins["customValidationMessage"] = pug_interp = function(key){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv" + (" class=\"invalid-feedback mt-2\""+pug.attr("hidden", true, true, true)+pug.attr("data-ol-custom-form-message", key, true, true)) + "\u003E\u003Ci class=\"fa fa-fw fa-warning me-1\" aria-hidden=\"true\"\u003E\u003C\u002Fi\u003E\u003Cdiv\u003E";
block && block();
...
pug_html = pug_html + "\u003Cmain class=\"content content-alt\" id=\"main-content\"\u003E\u003Cdiv class=\"container-custom-sm mx-auto\"\u003E\u003Cdiv class=\"card\"\u003E\u003Cform data-ol-async-form name=\"passwordResetForm\" action=\"\u002Fuser\u002Fpassword\u002Fset\" method=\"POST\" data-ol-hide-on-error=\"token-expired\"\u003E\u003Cdiv hidden data-ol-sent\u003E\u003Ch3 class=\"mt-0 mb-2\"\u003E" + (pug.escape(null == (pug_interp = translate("password_updated")) ? "" : pug_interp)) + "\u003C\u002Fh3\u003E\u003Cp class=\"mb-4\"\u003E" + (pug.escape(null == (pug_interp = translate("your_password_has_been_successfully_changed")) ? "" : pug_interp)) + ".\u003C\u002Fp\u003E\u003Ca href=\"\u002Flogin\"\u003E" + (pug.escape(null == (pug_interp = translate("log_in_now")) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E\u003Cdiv data-ol-not-sent\u003E\u003Ch3 class=\"mt-0 mb-2\"\u003E" + (pug.escape(null == (pug_interp = translate("reset_your_password")) ? "" : pug_interp)) + "\u003C\u002Fh3\u003E\u003Cp data-ol-hide-on-error-message=\"token-expired\"\u003E" + (pug.escape(null == (pug_interp = translate("create_a_new_password_for_your_account")) ? "" : pug_interp)) + ".\u003C\u002Fp\u003E";
pug_mixins["formMessages"]();
pug_mixins["customFormMessage"].call({
block: function(){
pug_html = pug_html + (pug.escape(null == (pug_interp = translate('invalid_password_contains_email')) ? "" : pug_interp)) + ".\n" + (pug.escape(null == (pug_interp = translate('use_a_different_password')) ? "" : pug_interp)) + ".";
}
}, 'password-contains-email', 'danger');
pug_mixins["customFormMessage"].call({
block: function(){
pug_html = pug_html + (pug.escape(null == (pug_interp = translate('invalid_password_too_similar')) ? "" : pug_interp)) + ".\n" + (pug.escape(null == (pug_interp = translate('use_a_different_password')) ? "" : pug_interp)) + ".";
}
}, 'password-too-similar', 'danger');
pug_mixins["customFormMessage"].call({
block: function(){
pug_html = pug_html + (pug.escape(null == (pug_interp = translate('password_reset_token_expired')) ? "" : pug_interp)) + "\u003Cbr\u003E\u003Ca href=\"\u002Fuser\u002Fpassword\u002Freset\"\u003E" + (pug.escape(null == (pug_interp = translate('request_new_password_reset_email')) ? "" : pug_interp)) + "\u003C\u002Fa\u003E";
}
}, 'token-expired', 'danger');
pug_html = pug_html + "\u003Cinput" + (" type=\"hidden\" name=\"_csrf\""+pug.attr("value", csrfToken, true, true)) + "\u003E\u003Cinput" + (" type=\"text\""+pug.attr("hidden", true, true, true)+" name=\"email\" autocomplete=\"username\""+pug.attr("value", email, true, true)) + "\u003E\u003Cdiv class=\"form-group\"\u003E\u003Clabel for=\"passwordField\" data-ol-hide-on-error-message=\"token-expired\"\u003E" + (pug.escape(null == (pug_interp = translate("new_password")) ? "" : pug_interp)) + "\u003C\u002Flabel\u003E\u003Cinput" + (" class=\"form-control\""+" id=\"passwordField\" type=\"password\" name=\"password\""+pug.attr("placeholder", translate("enter_your_new_password"), true, true)+" autocomplete=\"new-password\""+pug.attr("autofocus", true, true, true)+pug.attr("required", true, true, true)+pug.attr("minlength", settings.passwordStrengthOptions.length.min, true, true)) + "\u003E";
pug_mixins["customValidationMessage"].call({
block: function(){
pug_html = pug_html + (pug.escape(null == (pug_interp = translate('invalid_password')) ? "" : pug_interp)) + ".";
}
}, 'invalid-password');
pug_mixins["customValidationMessage"].call({
block: function(){
pug_html = pug_html + (pug.escape(null == (pug_interp = translate('password_cant_be_the_same_as_current_one')) ? "" : pug_interp)) + ".";
}
}, 'password-must-be-different');
pug_mixins["customValidationMessage"].call({
block: function(){
pug_html = pug_html + (null == (pug_interp = translate('password_was_detected_on_a_public_list_of_known_compromised_passwords', {}, [{name: 'a', attrs: {href: 'https://haveibeenpwned.com/passwords', rel: 'noopener noreferrer', target: '_blank'}}])) ? "" : pug_interp) + ".\n" + (pug.escape(null == (pug_interp = translate('use_a_different_password')) ? "" : pug_interp)) + ".";
}
}, 'password-must-be-strong');
pug_html = pug_html + "\u003Cinput" + (" type=\"hidden\" name=\"passwordResetToken\""+pug.attr("value", passwordResetToken, true, true)) + "\u003E\u003C\u002Fdiv\u003E\u003Cdiv data-ol-hide-on-error-message=\"token-expired\"\u003E\u003Cdiv\u003E" + (pug.escape(null == (pug_interp = translate('in_order_to_have_a_secure_account_make_sure_your_password')) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003Cul class=\"mb-4 ps-4\"\u003E\u003Cli\u003E" + (pug.escape(null == (pug_interp = translate('is_longer_than_n_characters', {n: settings.passwordStrengthOptions.length.min})) ? "" : pug_interp)) + "\u003C\u002Fli\u003E\u003Cli\u003E" + (pug.escape(null == (pug_interp = translate('does_not_contain_or_significantly_match_your_email')) ? "" : pug_interp)) + "\u003C\u002Fli\u003E\u003Cli\u003E" + (pug.escape(null == (pug_interp = translate('is_not_used_on_any_other_website')) ? "" : pug_interp)) + "\u003C\u002Fli\u003E\u003C\u002Ful\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"actions\"\u003E\u003Cbutton" + (" class=\"btn btn-primary w-100\""+" type=\"submit\""+pug.attr("data-ol-disabled-inflight", true, true, true)+pug.attr("aria-label", translate('set_new_password'), true, true)) + "\u003E \u003Cspan data-ol-inflight=\"idle\"\u003E" + (pug.escape(null == (pug_interp = translate('set_new_password')) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cspan hidden data-ol-inflight=\"pending\"\u003E" + (pug.escape(null == (pug_interp = translate('set_new_password')) ? "" : pug_interp)) + "… \u003C\u002Fspan\u003E\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fform\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fmain\u003E";
...
pug_html = pug_html + "\u003Cscript" + (" type=\"text\u002Fjavascript\""+pug.attr("nonce", scriptNonce, true, true)) + "\u003Ewindow.addEventListener('DOMContentLoaded', function() {\n\t\u002F\u002F- Look for bundle\n\tvar cdnBlocked = typeof Frontend === 'undefined'\n\t\u002F\u002F- Prevent loops\n\tvar noCdnAlreadyInUrl = window.location.href.indexOf(\"nocdn=true\") != -1\n\tif (cdnBlocked && !noCdnAlreadyInUrl && navigator.userAgent.indexOf(\"Googlebot\") == -1) {\n\t\t\u002F\u002F- Set query param, server will not set CDN url\n\t\twindow.location.search += \"&nocdn=true\";\n\t}\n})\u003C\u002Fscript\u003E\u003C\u002Fhtml\u003E";
        ...
        typeof dictionariesRoot !== 'undefined' ? dictionariesRoot : undefined, "email" in locals_for_with ?
        locals_for_with.email :
        typeof email !== 'undefined' ? email : undefined, "enableUpgradeButton" in locals_for_with ?
        ...
        locals_for_with.nav :
        typeof nav !== 'undefined' ? nav : undefined, "passwordResetToken" in locals_for_with ?
        locals_for_with.passwordResetToken :
        typeof passwordResetToken !== 'undefined' ? passwordResetToken : undefined, "projectDashboardReact" in locals_for_with ?
