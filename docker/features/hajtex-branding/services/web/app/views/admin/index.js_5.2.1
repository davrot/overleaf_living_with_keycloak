...
pug_html = pug_html + "\u003Cdiv class=\"content content-alt\" id=\"main-content\"\u003E\u003Cdiv class=\"container\"\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-xs-12\"\u003E\u003Cdiv class=\"card\"\u003E\u003Cdiv class=\"page-header\"\u003E\u003Ch1\u003EAdmin Panel\u003C\u002Fh1\u003E\u003C\u002Fdiv\u003E\u003Cdiv data-ol-bookmarkable-tabset\u003E\u003Cul class=\"nav nav-tabs\" role=\"tablist\"\u003E";
pug_mixins["bookmarkable-tabset-header"]('system-messages', 'System Messages', true);
pug_mixins["bookmarkable-tabset-header"]('open-sockets', 'Open Sockets');
pug_mixins["bookmarkable-tabset-header"]('open-close-editor', 'Open/Close Editor');
if (hasFeature('saas')) {
pug_mixins["bookmarkable-tabset-header"]('tpds', 'TPDS/Dropbox Management');
}
pug_html = pug_html + "\u003C\u002Ful\u003E\u003Cdiv class=\"tab-content\"\u003E\u003Cdiv class=\"tab-pane active\" role=\"tabpanel\" id=\"system-messages\"\u003E";
// iterate systemMessages
;(function(){
  var $$obj = systemMessages;
  if ('number' == typeof $$obj.length) {
      for (var pug_index12 = 0, $$l = $$obj.length; pug_index12 < $$l; pug_index12++) {
        var message = $$obj[pug_index12];
pug_html = pug_html + "\u003Cdiv class=\"alert alert-info row-spaced\"\u003E" + (pug.escape(null == (pug_interp = message.content) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E";
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + "\u003Cscript" + (" type=\"text\u002Fjavascript\""+pug.attr("nonce", scriptNonce, true, true)) + "\u003Ewindow.addEventListener('DOMContentLoaded', function() {\n\t\u002F\u002F- Look for bundle\n\tvar cdnBlocked = typeof Frontend === 'undefined'\n\t\u002F\u002F- Prevent loops\n\tvar noCdnAlreadyInUrl = window.location.href.indexOf(\"nocdn=true\") != -1\n\tif (cdnBlocked && !noCdnAlreadyInUrl && navigator.userAgent.indexOf(\"Googlebot\") == -1) {\n\t\t\u002F\u002F- Set query param, server will not set CDN url\n\t\twindow.location.search += \"&nocdn=true\";\n\t}\n})\u003C\u002Fscript\u003E\u003C\u002Fhtml\u003E";
        ...
        locals_for_with.nav :
        typeof nav !== 'undefined' ? nav : undefined, "openSockets" in locals_for_with ?
        locals_for_with.openSockets :
        typeof openSockets !== 'undefined' ? openSockets : undefined, "projectDashboardReact" in locals_for_with ?
        ...
        typeof suppressSkipToContent !== 'undefined' ? suppressSkipToContent : undefined, "systemMessages" in locals_for_with ?
        locals_for_with.systemMessages :
        typeof systemMessages !== 'undefined' ? systemMessages : undefined, "title" in locals_for_with ?
