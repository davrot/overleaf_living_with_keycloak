...
pug_html = pug_html + "\u003Cmain class=\"content content-alt team-invite\" id=\"main-content\"\u003E\u003Cdiv class=\"container\"\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv" + (pug.attr("class", pug.classes([colClass], [true]), false, true)) + "\u003E\u003Cdiv class=\"card text-center\"\u003E\u003Cdiv class=\"card-body\"\u003E\u003Cdiv class=\"page-header\"\u003E\u003C!-- TODO: Remove `team-invite-name` once we fully migrated to Bootstrap 5--\u003E\u003Ch1 class=\"text-centered\"\u003E" + (null == (pug_interp = translate("invited_to_group", {inviterName: inviterName, appName: appName }, [{name: 'span', attrs: {class: 'team-invite-name'}}])) ? "" : pug_interp) + "\u003C\u002Fh1\u003E\u003C\u002Fdiv\u003E";
if ((accountExists)) {
pug_html = pug_html + "\u003Cdiv\u003E\u003Cp\u003E" + (pug.escape(null == (pug_interp = translate("invited_to_group_login_benefits", {appName: appName})) ? "" : pug_interp)) + "\u003C\u002Fp\u003E\u003Cp\u003E" + (pug.escape(null == (pug_interp = translate("invited_to_group_login", {emailAddress: emailAddress})) ? "" : pug_interp)) + "\u003C\u002Fp\u003E\u003Cp\u003E\u003Ca" + (" class=\"btn btn-primary\""+pug.attr("href", `/login?redir=/subscription/invites/${inviteToken}`, true, true)) + "\u003E" + (pug.escape(null == (pug_interp = translate("login_to_accept_invitation")) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E";
}
else {
pug_html = pug_html + "\u003Cdiv\u003E\u003Cp\u003E" + (pug.escape(null == (pug_interp = translate("invited_to_group_register_benefits", {appName: appName})) ? "" : pug_interp)) + "\u003C\u002Fp\u003E\u003Cp\u003E" + (pug.escape(null == (pug_interp = translate("invited_to_group_register", {inviterName: inviterName})) ? "" : pug_interp)) + "\u003C\u002Fp\u003E\u003Cp\u003E\u003Ca" + (" class=\"btn btn-primary\""+pug.attr("href", `/register?redir=/subscription/invites/${inviteToken}`, true, true)) + "\u003E" + (pug.escape(null == (pug_interp = translate("register_to_accept_invitation")) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E";
}
...
pug_html = pug_html + "\u003Cscript" + (" type=\"text\u002Fjavascript\""+pug.attr("nonce", scriptNonce, true, true)) + "\u003Ewindow.addEventListener('DOMContentLoaded', function() {\n\t\u002F\u002F- Look for bundle\n\tvar cdnBlocked = typeof Frontend === 'undefined'\n\t\u002F\u002F- Prevent loops\n\tvar noCdnAlreadyInUrl = window.location.href.indexOf(\"nocdn=true\") != -1\n\tif (cdnBlocked && !noCdnAlreadyInUrl && navigator.userAgent.indexOf(\"Googlebot\") == -1) {\n\t\t\u002F\u002F- Set query param, server will not set CDN url\n\t\twindow.location.search += \"&nocdn=true\";\n\t}\n})\u003C\u002Fscript\u003E\u003C\u002Fhtml\u003E";
        ...
        typeof Object !== 'undefined' ? Object : undefined, "accountExists" in locals_for_with ?
        locals_for_with.accountExists :
        typeof accountExists !== 'undefined' ? accountExists : undefined, "appName" in locals_for_with ?
        locals_for_with.appName :
        typeof appName !== 'undefined' ? appName : undefined, "bootstrap5Override" in locals_for_with ?
        ...
        typeof canRedirectToAdminDomain !== 'undefined' ? canRedirectToAdminDomain : undefined, "colClass" in locals_for_with ?
        locals_for_with.colClass :
        typeof colClass !== 'undefined' ? colClass : undefined, "csrfToken" in locals_for_with ?
        ...
        typeof dictionariesRoot !== 'undefined' ? dictionariesRoot : undefined, "emailAddress" in locals_for_with ?
        locals_for_with.emailAddress :
        typeof emailAddress !== 'undefined' ? emailAddress : undefined, "enableUpgradeButton" in locals_for_with ?
        ...
        typeof hideFatFooter !== 'undefined' ? hideFatFooter : undefined, "inviteToken" in locals_for_with ?
        locals_for_with.inviteToken :
        typeof inviteToken !== 'undefined' ? inviteToken : undefined, "inviterName" in locals_for_with ?
        locals_for_with.inviterName :
        typeof inviterName !== 'undefined' ? inviterName : undefined, "isManagedAccount" in locals_for_with ?
