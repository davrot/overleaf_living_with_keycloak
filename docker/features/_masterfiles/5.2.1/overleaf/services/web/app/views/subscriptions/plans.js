...
pug_html = pug_html + "\u003Cmain class=\"content content-alt\" id=\"main-content\"\u003E\u003Cdiv class=\"content-page\"\u003E\u003Cdiv class=\"plans\"\u003E\u003Cdiv class=\"container\"\u003E";
if (showInrGeoBanner) {
pug_html = pug_html + "\u003Cdiv class=\"notification notification-type-success text-centered\"\u003E\u003Cdiv class=\"notification-content\"\u003E" + (null == (pug_interp = translate("inr_discount_offer_plans_page_banner", {flag: '🇮🇳'})) ? "" : pug_interp) + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
}
if (showBrlGeoBanner) {
pug_html = pug_html + "\u003Cdiv class=\"notification notification-type-success text-centered\"\u003E\u003Cdiv class=\"notification-content\"\u003E" + (null == (pug_interp = translate("brl_discount_offer_plans_page_banner", {flag: '🇧🇷'})) ? "" : pug_interp) + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
}
if (showLATAMBanner) {
pug_html = pug_html + "\u003Cdiv class=\"notification notification-type-success text-centered\"\u003E\u003Cdiv class=\"notification-content\"\u003E" + (null == (pug_interp = translate("latam_discount_offer_plans_page_banner", {flag: latamCountryBannerDetails.latamCountryFlag, country: latamCountryBannerDetails.country, currency: latamCountryBannerDetails.currency, discount: latamCountryBannerDetails.discount })) ? "" : pug_interp) + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
}
pug_html = pug_html + "\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-md-12\"\u003E\u003Cdiv class=\"page-header centered plans-header text-centered top-page-header\"\u003E\u003Ch1 class=\"text-capitalize\"\u003E" + (pug.escape(null == (pug_interp = translate('choose_your_plan')) ? "" : pug_interp)) + "\u003C\u002Fh1\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
pug_mixins["features_premium"] = pug_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cli\u003E&nbsp;\u003C\u002Fli\u003E\u003Cli\u003E\u003Cstrong\u003E" + (pug.escape(null == (pug_interp = translate('all_premium_features')) ? "" : pug_interp)) + "\u003C\u002Fstrong\u003E\u003C\u002Fli\u003E\u003Cli\u003E" + (pug.escape(null == (pug_interp = translate('sync_dropbox_github')) ? "" : pug_interp)) + "\u003C\u002Fli\u003E\u003Cli\u003E" + (pug.escape(null == (pug_interp = translate('full_doc_history')) ? "" : pug_interp)) + "\u003C\u002Fli\u003E\u003Cli\u003E" + (pug.escape(null == (pug_interp = translate('track_changes')) ? "" : pug_interp)) + "\u003C\u002Fli\u003E\u003Cli\u003E+ " + (pug.escape(null == (pug_interp = translate('more').toLowerCase()) ? "" : pug_interp)) + "\u003C\u002Fli\u003E";
};
...
pug_html = pug_html + "\u003Cth" + (pug.attr("class", pug.classes([thClass], [true]), false, true)+pug.attr("aria-label", ariaLabel, true, true)+pug.attr("colspan", colspan, true, true)+pug.attr("scope", scopeValue, true, true)) + "\u003E\u003Cdiv class=\"plans-v2-table-th\"\u003E";
if ((highlighted)) {
pug_html = pug_html + "\u003Cp class=\"plans-v2-table-green-highlighted-text\"\u003E" + (pug.escape(null == (pug_interp = translate(config.highlightedColumn.text[period]).toUpperCase()) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
}
switch (tableHeadKey){
case 'individual_free':
pug_mixins["table_head_individual_free"](highlighted, period);
  break;
case 'individual_collaborator':
pug_mixins["table_head_individual_collaborator"](highlighted, eventTrackingKey, additionalEventSegmentation, period);
  break;
case 'individual_professional':
pug_mixins["table_head_individual_professional"](highlighted, eventTrackingKey, additionalEventSegmentation, period);
  break;
case 'group_collaborator':
pug_mixins["table_head_group_collaborator"](highlighted, eventTrackingKey, additionalEventSegmentation);
  break;
case 'group_professional':
pug_mixins["table_head_group_professional"](highlighted, eventTrackingKey, additionalEventSegmentation);
  break;
case 'group_organization':
pug_mixins["table_head_group_organization"](highlighted, eventTrackingKey, additionalEventSegmentation);
  break;
case 'student_free':
pug_mixins["table_head_student_free"](highlighted, period);
  break;
case 'student_student':
pug_mixins["table_head_student_student"](highlighted, eventTrackingKey, additionalEventSegmentation, period, tableHeadOptions.showExtraContent);
  break;
case 'student_university':
pug_mixins["table_head_student_university"](highlighted, eventTrackingKey, additionalEventSegmentation, period);
  break;
}
...
;(function(){
  ...
  if ('number' == typeof $$obj.length) {
      for (var pug_index12 = 0, $$l = $$obj.length; pug_index12 < $$l; pug_index12++) {
        var featuresPerSection = $$obj[pug_index12];
...
pug_html = pug_html + "\u003Ctd" + (pug.attr("class", pug.classes([tdClass], [true]), false, true)+pug.attr("colspan", colspan, true, true)) + "\u003E";
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Ctable class=\"card plans-v2-table plans-v2-table-individual\"\u003E";
pug_mixins["plans_v2_table"](period, plansConfig.individual);
pug_html = pug_html + "\u003C\u002Ftable\u003E";
};
pug_mixins["table_group"] = pug_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Ctable class=\"card plans-v2-table plans-v2-table-group\"\u003E";
pug_mixins["plans_v2_table"]('annual', plansConfig.group);
pug_html = pug_html + "\u003C\u002Ftable\u003E";
};
pug_mixins["table_student"] = pug_interp = function(period){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Ctable class=\"card plans-v2-table plans-v2-table-student\"\u003E";
pug_mixins["plans_v2_table"](period, plansConfig.student);
pug_html = pug_html + "\u003C\u002Ftable\u003E";
};
pug_mixins["table_head_individual_free"] = pug_interp = function(highlighted, period){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv class=\"plans-v2-table-th-content\"\u003E\u003Cp class=\"plans-v2-table-th-content-title\"\u003E" + (pug.escape(null == (pug_interp = translate("free")) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
pug_mixins["table_head_price"]('free', period);
pug_html = pug_html + "\u003Cdiv class=\"plans-v2-table-btn-buy-container-mobile\"\u003E";
pug_mixins["btn_buy_individual_free"](highlighted);
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cul class=\"plans-v2-table-th-content-benefit\"\u003E\u003Cli\u003E" + (pug.escape(null == (pug_interp = translate("one_collaborator")) ? "" : pug_interp)) + "\u003C\u002Fli\u003E\u003C\u002Ful\u003E\u003Cdiv class=\"plans-v2-table-btn-buy-container-desktop\"\u003E";
pug_mixins["btn_buy_individual_free"](highlighted);
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
};
pug_mixins["table_head_individual_collaborator"] = pug_interp = function(highlighted, eventTrackingKey, additionalEventSegmentation, period){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv class=\"plans-v2-table-th-content\"\u003E\u003Cp class=\"plans-v2-table-th-content-title\"\u003E" + (pug.escape(null == (pug_interp = translate("standard")) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cul class=\"plans-v2-table-th-content-benefit\"\u003E\u003Cli\u003E" + (null == (pug_interp = translate("x_collaborators_per_project", {collaboratorsCount: '10'})) ? "" : pug_interp) + "\u003C\u002Fli\u003E\u003Cli\u003E" + (pug.escape(null == (pug_interp = translate("all_premium_features")) ? "" : pug_interp)) + "\u003C\u002Fli\u003E\u003C\u002Ful\u003E\u003Cdiv class=\"plans-v2-table-btn-buy-container-desktop\"\u003E";
pug_mixins["btn_buy_individual_collaborator"](highlighted, eventTrackingKey, additionalEventSegmentation, period);
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
};
pug_mixins["table_head_individual_professional"] = pug_interp = function(highlighted, eventTrackingKey, additionalEventSegmentation, period){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv class=\"plans-v2-table-th-content\"\u003E\u003Cp class=\"plans-v2-table-th-content-title\"\u003E" + (pug.escape(null == (pug_interp = translate("professional")) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cul class=\"plans-v2-table-th-content-benefit\"\u003E\u003Cli\u003E" + (null == (pug_interp = translate("unlimited_collabs_rt",{},["b"])) ? "" : pug_interp) + "\u003C\u002Fli\u003E\u003Cli\u003E" + (pug.escape(null == (pug_interp = translate("all_premium_features")) ? "" : pug_interp)) + "\u003C\u002Fli\u003E\u003C\u002Ful\u003E\u003Cdiv class=\"plans-v2-table-btn-buy-container-desktop\"\u003E";
pug_mixins["btn_buy_individual_professional"](highlighted, eventTrackingKey, additionalEventSegmentation, period);
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
};
pug_mixins["table_head_group_collaborator"] = pug_interp = function(highlighted, eventTrackingKey, additionalEventSegmentation){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv class=\"plans-v2-table-th-content\"\u003E\u003Cp class=\"plans-v2-table-th-content-title\"\u003E" + (pug.escape(null == (pug_interp = translate("group_standard")) ? "" : pug_interp)) + "\u003C\u002Fp\u003E\u003Cdiv class=\"plans-v2-table-price-container\"\u003E\u003Cs class=\"plans-v2-table-price-before-discount\"\u003E";
pug_mixins["gen_localized_price_for_plan_view"]('collaborator', 'annual');
pug_html = pug_html + "\u003C\u002Fs\u003E\u003Cp class=\"plans-v2-table-price\"\u003E\u003Cspan data-ol-plans-v2-group-price-per-user=\"collaborator\"\u003E" + (pug.escape(null == (pug_interp = initialLocalizedGroupPrice.pricePerUser.collaborator) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fp\u003E\u003Cp class=\"plans-v2-table-price-period-label\"\u003E" + (pug.escape(null == (pug_interp = translate('per_user_year')) ? "" : pug_interp)) + "\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"plans-v2-table-btn-buy-container-mobile\"\u003E";
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cul class=\"plans-v2-table-th-content-benefit\"\u003E\u003Cli\u003E" + (pug.escape(null == (pug_interp = translate("up_to")) ? "" : pug_interp)) + " " + (null == (pug_interp = translate("x_collaborators_per_project", {collaboratorsCount: '10'})) ? "" : pug_interp) + "\u003C\u002Fli\u003E\u003Cli\u003E";
pug_mixins["table_head_group_total_per_year"]('collaborator');
pug_html = pug_html + "\u003C\u002Fli\u003E\u003C\u002Ful\u003E\u003Cdiv class=\"plans-v2-table-btn-buy-container-desktop\"\u003E";
pug_mixins["btn_buy_group_collaborator"](highlighted, eventTrackingKey);
pug_mixins["additional_link_group"](eventTrackingKey, additionalEventSegmentation, 'group_collaborator');
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
};
pug_mixins["table_head_group_professional"] = pug_interp = function(highlighted, eventTrackingKey, additionalEventSegmentation){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv class=\"plans-v2-table-th-content\"\u003E\u003Cp class=\"plans-v2-table-th-content-title\"\u003E" + (pug.escape(null == (pug_interp = translate("group_professional")) ? "" : pug_interp)) + "\u003C\u002Fp\u003E\u003Cdiv class=\"plans-v2-table-price-container\"\u003E\u003Cs class=\"plans-v2-table-price-before-discount\"\u003E";
pug_mixins["gen_localized_price_for_plan_view"]('professional', 'annual');
pug_html = pug_html + "\u003C\u002Fs\u003E\u003Cp class=\"plans-v2-table-price\"\u003E\u003Cspan data-ol-plans-v2-group-price-per-user=\"professional\"\u003E" + (pug.escape(null == (pug_interp = initialLocalizedGroupPrice.pricePerUser.professional) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fp\u003E\u003Cp class=\"plans-v2-table-price-period-label\"\u003E" + (pug.escape(null == (pug_interp = translate('per_user_year')) ? "" : pug_interp)) + "\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"plans-v2-table-btn-buy-container-mobile\"\u003E";
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cul class=\"plans-v2-table-th-content-benefit\"\u003E\u003Cli\u003E" + (pug.escape(null == (pug_interp = translate("unlimited_collaborators_in_each_project")) ? "" : pug_interp)) + "\u003C\u002Fli\u003E\u003Cli\u003E";
...
pug_html = pug_html + "\u003Cspan" + (" class=\"plans-v2-group-total-price\""+pug.attr("data-ol-plans-v2-group-total-price", groupPlan, true, true)) + "\u003E" + (pug.escape(null == (pug_interp = initialLocalizedGroupPrice.price[groupPlan]) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E&nbsp;";
...
;(function(){
  ...
  if ('number' == typeof $$obj.length) {
      for (var pug_index19 = 0, $$l = $$obj.length; pug_index19 < $$l; pug_index19++) {
        var licenseSize = $$obj[pug_index19];
...
pug_mixins["table_head_group_organization"] = pug_interp = function(highlighted, eventTrackingKey, additionalEventSegmentation){
var block = (this && this.block), attributes = (this && this.attributes) || {};
...
pug_html = pug_html + "\u003Cdiv class=\"plans-v2-table-th-content\"\u003E\u003Cp class=\"plans-v2-table-th-content-title\"\u003E" + (pug.escape(null == (pug_interp = translate("organization")) ? "" : pug_interp)) + "\u003C\u002Fp\u003E\u003Cdiv class=\"plans-v2-table-comments-icon\"\u003E\u003Ci class=\"fa fa-comments-o\"\u003E\u003C\u002Fi\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"plans-v2-table-btn-buy-container-mobile\"\u003E";
pug_mixins["btn_buy_group_organization"](highlighted, eventTrackingKey);
pug_html = pug_html + "\u003Csmall class=\"plans-v2-table-th-content-additional-link invisible\" aria-hidden=\"true\"\u003E\u003C\u002Fsmall\u003E\u003C\u002Fdiv\u003E\u003Cul class=\"plans-v2-table-th-content-benefit\"\u003E\u003Cli\u003E" + (pug.escape(null == (pug_interp = translate("best_choices_companies_universities_non_profits")) ? "" : pug_interp)) + "\u003C\u002Fli\u003E\u003Cli\u003E" + (pug.escape(null == (pug_interp = translate("for_groups_or_site_wide")) ? "" : pug_interp)) + "\u003C\u002Fli\u003E\u003Cli\u003E\u003Ca" + (" target=\"_blank\" href=\"\u002Ffor\u002Fcontact-sales\" event-tracking=\"plans-page-click\" event-tracking-mb=\"true\" event-tracking-trigger=\"click\""+pug.attr("event-segmentation", segmentation, true, true)) + "\u003E" + (pug.escape(null == (pug_interp = translate("also_available_as_on_premises")) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003C\u002Fli\u003E\u003C\u002Ful\u003E\u003Cdiv class=\"plans-v2-table-btn-buy-container-desktop\"\u003E";
pug_mixins["btn_buy_group_organization"](highlighted, eventTrackingKey);
pug_html = pug_html + "\u003Csmall class=\"plans-v2-table-th-content-additional-link invisible\" aria-hidden=\"true\"\u003E\u003C\u002Fsmall\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
};
pug_mixins["table_head_student_free"] = pug_interp = function(highlighted, period){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv class=\"plans-v2-table-th-content\"\u003E\u003Cp class=\"plans-v2-table-th-content-title\"\u003E" + (pug.escape(null == (pug_interp = translate("free")) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
pug_mixins["table_head_price"]('free', period);
pug_html = pug_html + "\u003Cdiv class=\"plans-v2-table-btn-buy-container-mobile\"\u003E";
...
pug_mixins["table_head_student_student"] = pug_interp = function(highlighted, eventTrackingKey, additionalEventSegmentation, period, showExtraContent){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv class=\"plans-v2-table-th-content\"\u003E\u003Cp class=\"plans-v2-table-th-content-title\"\u003E" + (pug.escape(null == (pug_interp = translate("student")) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cul class=\"plans-v2-table-th-content-benefit\"\u003E\u003Cli\u003E" + (null == (pug_interp = translate("x_collaborators_per_project", {collaboratorsCount: '6'})) ? "" : pug_interp) + "\u003C\u002Fli\u003E\u003Cli\u003E" + (pug.escape(null == (pug_interp = translate("all_premium_features")) ? "" : pug_interp)) + "\u003C\u002Fli\u003E";
if (showExtraContent) {
pug_html = pug_html + "\u003Cli\u003E \u003Cb\u003E" + (null == (pug_interp = translate("for_students_only")) ? "" : pug_interp) + "\u003C\u002Fb\u003E\u003C\u002Fli\u003E";
}
pug_html = pug_html + "\u003C\u002Ful\u003E\u003Cdiv class=\"plans-v2-table-btn-buy-container-desktop\"\u003E";
pug_mixins["btn_buy_student_student"](highlighted, eventTrackingKey, additionalEventSegmentation, period);
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
};
pug_mixins["table_head_student_university"] = pug_interp = function(highlighted, eventTrackingKey, additionalEventSegmentation, period){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv class=\"plans-v2-table-th-content\"\u003E\u003Cp class=\"plans-v2-table-th-content-title\"\u003E" + (pug.escape(null == (pug_interp = translate("university")) ? "" : pug_interp)) + "\u003C\u002Fp\u003E\u003Cdiv class=\"plans-v2-table-comments-icon\"\u003E\u003Ci class=\"fa fa-comments-o\"\u003E\u003C\u002Fi\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"plans-v2-table-btn-buy-container-mobile\"\u003E";
pug_mixins["btn_buy_student_university"](highlighted, eventTrackingKey, additionalEventSegmentation, period);
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cp class=\"plans-v2-table-th-content-benefit\"\u003E" + (null == (pug_interp = translate("all_our_group_plans_offer_educational_discount", {}, [{name: 'b'}, {name: 'b'}])) ? "" : pug_interp) + "\u003C\u002Fp\u003E\u003Cdiv class=\"plans-v2-table-btn-buy-container-desktop\"\u003E";
pug_mixins["btn_buy_student_university"](highlighted, eventTrackingKey, additionalEventSegmentation, period);
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
};
pug_mixins["table_head_price"] = pug_interp = function(plan, period){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv class=\"plans-v2-table-price-container\"\u003E";
if (plan !== 'free' && period === 'annual') {
pug_html = pug_html + "\u003Cs class=\"plans-v2-table-price-before-discount\"\u003E";
pug_mixins["gen_localized_price_for_plan_view"](plan, 'monthlyTimesTwelve');
pug_html = pug_html + "\u003C\u002Fs\u003E";
}
pug_html = pug_html + "\u003Cp class=\"plans-v2-table-price\"\u003E";
pug_mixins["gen_localized_price_for_plan_view"](plan, period);
pug_html = pug_html + "\u003C\u002Fp\u003E\u003Cp class=\"plans-v2-table-price-period-label\"\u003E";
if (period == 'annual') {
...
pug_html = pug_html + "\u003Cdiv class=\"plans-v2-table-cell\"\u003E\u003Cdiv" + (" class=\"plans-v2-table-cell-content\""+pug.attr("data-ol-plans-v2-table-cell-plan", plan, true, true)+pug.attr("data-ol-plans-v2-table-cell-feature", featureName, true, true)) + "\u003E";
...
if ((planValue)) {
pug_html = pug_html + "\u003Ci class=\"fa fa-check\" aria-hidden=\"true\"\u003E\u003C\u002Fi\u003E\u003Cspan class=\"sr-only\"\u003E" + (pug.escape(null == (pug_interp = translate("feature_included")) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
else {
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
if ((!getSessionUser())) {
pug_html = pug_html + "\u003Ca" + (pug.attr("class", pug.classes(["btn","plans-v2-table-btn-buy",(highlighted ? 'btn-primary' : 'btn-default')], [false,false,true]), false, true)+" href=\"\u002Fregister\"") + "\u003E\u003Cspan\u003E" + (pug.escape(null == (pug_interp = translate("try_for_free")) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fa\u003E";
}
else {
pug_html = pug_html + "\u003Ca" + (pug.attr("class", pug.classes(["btn","plans-v2-table-btn-buy","invisible",(highlighted ? 'btn-primary' : 'btn-default')], [false,false,false,true]), false, true)+" aria-hidden=\"true\"") + "\u003E\u003C\u002Fa\u003E";
}
};
...
pug_mixins["btn_buy_student_university"] = pug_interp = function(highlighted, eventTrackingKey, additionalEventSegmentation, period){
var block = (this && this.block), attributes = (this && this.attributes) || {};
...
pug_html = pug_html + "\u003Csmall class=\"plans-v2-table-th-content-additional-link\"\u003E" + (pug.escape(null == (pug_interp = translate("or")) ? "" : pug_interp)) + " \u003Ca" + (" href=\"\u002Ffor\u002Fcontact-sales\" target=\"_blank\""+pug.attr("event-tracking", eventTrackingKey, true, true)+" event-tracking-mb=\"true\" event-tracking-trigger=\"click\""+pug.attr("event-segmentation", segmentation, true, true)) + "\u003E" + (pug.escape(null == (pug_interp = translate("contact_us_lowercase")) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003C\u002Fsmall\u003E";
};
...
pug_html = pug_html + "\u003Csmall class=\"plans-v2-table-th-content-additional-link\"\u003E" + (pug.escape(null == (pug_interp = translate("or")) ? "" : pug_interp)) + " \u003Ca" + (pug.attr("href", `/user/subscription/new?${qs.toString()}`, true, true)+pug.attr("event-tracking", eventTrackingKey, true, true)+" event-tracking-mb=\"true\" event-tracking-trigger=\"click\""+pug.attr("event-segmentation", segmentation, true, true)) + "\u003E" + (pug.escape(null == (pug_interp = translate("buy_now_no_exclamation_mark")) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003C\u002Fsmall\u003E";
};
pug_mixins["plans_v2_table_sticky_header"] = pug_interp = function(withSwitch, config){
var block = (this && this.block), attributes = (this && this.attributes) || {};
var tableHeadKeys = Object.keys(config.tableHead)
pug_html = pug_html + "\u003Cdiv" + (pug.attr("class", pug.classes(["row","plans-v2-table-sticky-header","sticky",(withSwitch ? 'plans-v2-table-sticky-header-with-switch' : 'plans-v2-table-sticky-header-without-switch')], [false,false,false,true]), false, true)+pug.attr("data-ol-plans-v2-table-sticky-header", true, true, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug.attr("class", pug.classes(["plans-v2-table-sticky-header-item",elClass], [false,true]), false, true)) + "\u003E";
switch (tableHeadKey){
case 'individual_collaborator':
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv class=\"row plans-v2-table-sticky-header-container\" data-ol-plans-v2-view=\"individual\"\u003E";
pug_mixins["plans_v2_table_sticky_header"](true, plansConfig.individual);
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"row plans-v2-table-sticky-header-container\" hidden data-ol-plans-v2-view=\"group\"\u003E";
pug_mixins["plans_v2_table_sticky_header"](false, plansConfig.group);
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"row plans-v2-table-sticky-header-container\" hidden data-ol-plans-v2-view=\"student\"\u003E";
pug_mixins["plans_v2_table_sticky_header"](true, plansConfig.student);
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
};
...
pug_html = pug_html + "\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-md-4 col-md-offset-4 text-centered plans-v2-m-a-switch-container\" data-ol-plans-v2-m-a-switch-container\u003E\u003Cdiv class=\"plans-v2-m-a-switch-annual-text-container\"\u003E\u003Cspan class=\"underline\" data-ol-plans-v2-m-a-switch-text=\"annual\"\u003E" + (pug.escape(null == (pug_interp = translate("annual")) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cdiv" + (pug.attr("class", pug.classes(["tooltip","in","left","plans-v2-m-a-tooltip",monthlyAnnualToggleChecked ? 'plans-v2-m-a-tooltip-monthly-selected' : ''], [false,false,false,false,true]), false, true)+" role=\"tooltip\""+pug.attr("data-ol-plans-v2-m-a-tooltip", true, true, true)) + "\u003E\u003Cdiv class=\"tooltip-arrow\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"tooltip-inner\"\u003E\u003Cspan" + (pug.attr("hidden", !monthlyAnnualToggleChecked, true, true)+" data-ol-tooltip-period=\"monthly\"") + "\u003E" + (pug.escape(null == (pug_interp = translate("save_20_percent_by_paying_annually")) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cspan" + (pug.attr("hidden", monthlyAnnualToggleChecked, true, true)+" data-ol-tooltip-period=\"annual\"") + "\u003E" + (pug.escape(null == (pug_interp = translate("saving_20_percent")) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Clabel class=\"plans-v2-m-a-switch\" data-ol-plans-v2-m-a-switch\u003E\u003Cinput" + (" type=\"checkbox\""+pug.attr("checked", monthlyAnnualToggleChecked, true, true)+" role=\"switch\""+pug.attr("aria-label", translate("select_monthly_plans"), true, true)+" autocomplete=\"off\""+pug.attr("event-tracking", eventTracking, true, true)+" event-tracking-mb=\"true\" event-tracking-trigger=\"click\" event-tracking-element=\"checkbox\""+pug.attr("event-segmentation", eventSegmentation, true, true)) + "\u003E\u003Cspan\u003E\u003C\u002Fspan\u003E\u003C\u002Flabel\u003E\u003Cspan data-ol-plans-v2-m-a-switch-text=\"monthly\"\u003E" + (pug.escape(null == (pug_interp = translate("monthly")) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
};
pug_html = pug_html + "\u003Cdiv class=\"row plans-v2-top-switch\"\u003E\u003Cdiv class=\"col-xs-12\"\u003E\u003Cul class=\"nav plans-v2-nav\" role=\"tablist\"\u003E\u003Cli class=\"active plans-v2-top-switch-individual\" data-ol-plans-v2-view-tab=\"individual\" event-tracking=\"plans-page-toggle-plan\" event-tracking-mb=\"true\" event-tracking-trigger=\"click\" event-segmentation=\"{&quot;button&quot;: &quot;individual&quot;}\" role=\"presentation\"\u003E\u003Cbutton class=\"btn btn-default-outline\" role=\"tab\" aria-controls=\"panel-individual\" aria-selected=\"true\"\u003E" + (pug.escape(null == (pug_interp = translate("indvidual_plans")) ? "" : pug_interp)) + "\u003C\u002Fbutton\u003E\u003C\u002Fli\u003E\u003Cli class=\"plans-v2-top-switch-group\" data-ol-plans-v2-view-tab=\"group\" event-tracking=\"plans-page-toggle-plan\" event-tracking-mb=\"true\" event-tracking-trigger=\"click\" event-segmentation=\"{&quot;button&quot;: &quot;group&quot;}\" role=\"presentation\"\u003E\u003Cbutton class=\"btn btn-default-outline\" aria-controls=\"panel-group\" href=\"#\" role=\"tab\" aria-selected=\"false\"\u003E\u003Cspan\u003E" + (pug.escape(null == (pug_interp = translate("group_plans")) ? "" : pug_interp)) + " \u003C\u002Fspan\u003E\u003Cspan\u003E(" + (pug.escape(null == (pug_interp = translate("save_30_percent_or_more")) ? "" : pug_interp)) + ")\u003C\u002Fspan\u003E\u003C\u002Fbutton\u003E\u003C\u002Fli\u003E\u003Cli class=\"plans-v2-top-switch-student\" data-ol-plans-v2-view-tab=\"student\" event-tracking=\"plans-page-toggle-plan\" event-tracking-mb=\"true\" event-tracking-trigger=\"click\" event-segmentation=\"{&quot;button&quot;: &quot;student&quot;}\" role=\"presentation\"\u003E\u003Cbutton class=\"btn btn-default-outline\" aria-controls=\"panel-student\" href=\"#\" role=\"tab\" aria-selected=\"false\"\u003E" + (pug.escape(null == (pug_interp = translate("student_plans")) ? "" : pug_interp)) + "\u003C\u002Fbutton\u003E\u003C\u002Fli\u003E\u003C\u002Ful\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
...
pug_html = pug_html + "\u003Cdiv class=\"row plans-v2-table-container\" hidden data-ol-plans-v2-period=\"monthly\"\u003E\u003Cdiv class=\"col-sm-12\" data-ol-plans-v2-view=\"individual\" role=\"tabpanel\"\u003E\u003Cdiv class=\"row\"\u003E";
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"row plans-v2-table-container\" data-ol-plans-v2-period=\"annual\"\u003E\u003Cdiv class=\"col-sm-12\" data-ol-plans-v2-view=\"individual\" id=\"panel-individual\" role=\"tabpanel\"\u003E\u003Cdiv class=\"row\"\u003E";
...
;(function(){
  ...
  if ('number' == typeof $$obj.length) {
      for (var pug_index20 = 0, $$l = $$obj.length; pug_index20 < $$l; pug_index20++) {
        var plan_code = $$obj[pug_index20];
pug_html = pug_html + "\u003Clabel class=\"group-plan-option\"\u003E\u003Cinput" + (" type=\"radio\" name=\"plan_code\""+pug.attr("checked", (plan_code.code === "collaborator"), true, true)+pug.attr("value", plan_code.code, true, true)+pug.attr("data-ol-group-plan-code", plan_code.code, true, true)) + "\u003E\u003Cspan\u003E" + (pug.escape(null == (pug_interp = translate(plan_code.i18n)) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Flabel\u003E";
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + "\u003Cscript" + (" type=\"text\u002Fjavascript\""+pug.attr("nonce", scriptNonce, true, true)) + "\u003Ewindow.addEventListener('DOMContentLoaded', function() {\n\t\u002F\u002F- Look for bundle\n\tvar cdnBlocked = typeof Frontend === 'undefined'\n\t\u002F\u002F- Prevent loops\n\tvar noCdnAlreadyInUrl = window.location.href.indexOf(\"nocdn=true\") != -1\n\tif (cdnBlocked && !noCdnAlreadyInUrl && navigator.userAgent.indexOf(\"Googlebot\") == -1) {\n\t\t\u002F\u002F- Set query param, server will not set CDN url\n\t\twindow.location.search += \"&nocdn=true\";\n\t}\n})\u003C\u002Fscript\u003E\u003C\u002Fhtml\u003E";
        ...
        typeof ExposedSettings !== 'undefined' ? ExposedSettings : undefined, "JSON" in locals_for_with ?
        ...
        typeof initialLocalizedGroupPrice !== 'undefined' ? initialLocalizedGroupPrice : undefined, "isManagedAccount" in locals_for_with ?
        ...
        locals_for_with.nav :
        typeof nav !== 'undefined' ? nav : undefined, "plansConfig" in locals_for_with ?
