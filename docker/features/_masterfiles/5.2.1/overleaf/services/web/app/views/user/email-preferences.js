var pug = require("pug-runtime");function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;
    ...
    (function (Date, ExposedSettings, Object, bootstrap5Override, brandVariation, buildBaseAssetPath, buildCssPath, buildImgPath, buildJsPath, canDisplayAdminMenu, canDisplayAdminRedirect, canDisplaySplitTestMenu, canDisplaySurveyMenu, canRedirectToAdminDomain, csrfToken, currentLngCode, currentUrl, currentUrlWithQueryParams, deferScripts, dictionariesRoot, enableUpgradeButton, entrypoint, entrypointScripts, entrypointStyles, fixedSizeDocument, getCssThemeModifier, getLoggedInUserId, getSessionAnalyticsId, getSessionUser, getUserEmail, hasAdminAccess, hasCustomLeftNav, hasFeature, hideFatFooter, isManagedAccount, mathJaxPath, metadata, moduleIncludes, nav, projectDashboardReact, scriptNonce, settings, showLanguagePicker, showThinFooter, splitTestInfo, splitTestVariants, submitAction, subscribed, suppressCookieBanner, suppressFooter, suppressGoogleAnalytics, suppressNavContentLinks, suppressNavbar, suppressNavbarRight, suppressRelAlternateLinks, suppressSkipToContent, title, translate, user, userRestrictions, userSettings, usersBestSubscription) {
      pug_mixins["back-to-btns"] = pug_interp = function(settingsAnchor){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Ca" + (" class=\"btn btn-secondary text-capitalize\""+pug.attr("href", `/user/settings${settingsAnchor ? '#' + settingsAnchor : '' }`, true, true)) + "\u003E" + (pug.escape(null == (pug_interp = translate('back_to_account_settings')) ? "" : pug_interp)) + "\u003C\u002Fa\u003E \u003Ca class=\"btn btn-secondary text-capitalize\" href=\"\u002Fproject\"\u003E" + (pug.escape(null == (pug_interp = translate('back_to_your_projects')) ? "" : pug_interp)) + "\u003C\u002Fa\u003E";
};
...
pug_html = pug_html + "\u003Cmain class=\"content content-alt\" id=\"main-content\"\u003E\u003Cdiv class=\"container\"\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2\"\u003E\u003Cdiv class=\"card\"\u003E\u003Cdiv class=\"page-header\"\u003E\u003Ch1\u003E" + (pug.escape(null == (pug_interp = translate("newsletter_info_title")) ? "" : pug_interp)) + "\u003C\u002Fh1\u003E\u003C\u002Fdiv\u003E\u003Cp\u003E" + (pug.escape(null == (pug_interp = translate("newsletter_info_summary")) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
var submitAction
if (subscribed) {
submitAction = '/user/newsletter/unsubscribe'
pug_html = pug_html + "\u003Cp\u003E" + (null == (pug_interp = translate("newsletter_info_subscribed", {}, ['strong'])) ? "" : pug_interp) + "\u003C\u002Fp\u003E";
}
else {
submitAction = '/user/newsletter/subscribe'
pug_html = pug_html + "\u003Cp\u003E" + (null == (pug_interp = translate("newsletter_info_unsubscribed", {}, ['strong'])) ? "" : pug_interp) + "\u003C\u002Fp\u003E";
}
pug_html = pug_html + "\u003Cform" + (pug.attr("data-ol-async-form", true, true, true)+pug.attr("data-ol-reload-on-success", true, true, true)+" name=\"newsletterForm\""+pug.attr("action", submitAction, true, true)+" method=\"POST\"") + "\u003E\u003Cinput" + (" name=\"_csrf\" type=\"hidden\""+pug.attr("value", csrfToken, true, true)) + "\u003E";
pug_mixins["formMessages"]();
pug_html = pug_html + "\u003Cp class=\"actions text-center\"\u003E";
if (subscribed) {
pug_html = pug_html + "\u003Cbutton class=\"btn-danger btn\" type=\"submit\" data-ol-disabled-inflight\u003E\u003Cspan data-ol-inflight=\"idle\"\u003E" + (pug.escape(null == (pug_interp = translate("unsubscribe")) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cspan hidden data-ol-inflight=\"pending\"\u003E" + (pug.escape(null == (pug_interp = translate("saving")) ? "" : pug_interp)) + "…\u003C\u002Fspan\u003E\u003C\u002Fbutton\u003E";
}
else {
pug_html = pug_html + "\u003Cbutton class=\"btn-primary btn\" type=\"submit\" data-ol-disabled-inflight\u003E\u003Cspan data-ol-inflight=\"idle\"\u003E" + (pug.escape(null == (pug_interp = translate("subscribe")) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cspan hidden data-ol-inflight=\"pending\"\u003E" + (pug.escape(null == (pug_interp = translate("saving")) ? "" : pug_interp)) + "…\u003C\u002Fspan\u003E\u003C\u002Fbutton\u003E";
}
pug_html = pug_html + "\u003C\u002Fp\u003E\u003C\u002Fform\u003E";
if (subscribed) {
pug_html = pug_html + "\u003Cp\u003E" + (pug.escape(null == (pug_interp = translate("newsletter_info_note")) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
}
pug_html = pug_html + "\u003Cdiv class=\"page-separator\"\u003E\u003C\u002Fdiv\u003E";
pug_mixins["back-to-btns"]();
...
pug_html = pug_html + "\u003Cscript" + (" type=\"text\u002Fjavascript\""+pug.attr("nonce", scriptNonce, true, true)) + "\u003Ewindow.addEventListener('DOMContentLoaded', function() {\n\t\u002F\u002F- Look for bundle\n\tvar cdnBlocked = typeof Frontend === 'undefined'\n\t\u002F\u002F- Prevent loops\n\tvar noCdnAlreadyInUrl = window.location.href.indexOf(\"nocdn=true\") != -1\n\tif (cdnBlocked && !noCdnAlreadyInUrl && navigator.userAgent.indexOf(\"Googlebot\") == -1) {\n\t\t\u002F\u002F- Set query param, server will not set CDN url\n\t\twindow.location.search += \"&nocdn=true\";\n\t}\n})\u003C\u002Fscript\u003E\u003C\u002Fhtml\u003E";
        ...
        typeof splitTestVariants !== 'undefined' ? splitTestVariants : undefined, "submitAction" in locals_for_with ?
        locals_for_with.submitAction :
        typeof submitAction !== 'undefined' ? submitAction : undefined, "subscribed" in locals_for_with ?
        locals_for_with.subscribed :
        typeof subscribed !== 'undefined' ? subscribed : undefined, "suppressCookieBanner" in locals_for_with ?
