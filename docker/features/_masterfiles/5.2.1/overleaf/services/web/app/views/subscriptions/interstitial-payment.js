...
;(function(){
  ...
  if ('number' == typeof $$obj.length) {
      for (var pug_index0 = 0, $$l = $$obj.length; pug_index0 < $$l; pug_index0++) {
        var featuresPerSection = $$obj[pug_index0];
...
pug_mixins["plans_v2_table_sticky_header"](true, interstitialPaymentConfig);
pug_html = pug_html + "\u003Cdiv class=\"row plans-v2-table-container\" data-ol-plans-v2-period=\"monthly\"\u003E\u003Cdiv class=\"col-sm-12\"\u003E\u003Cdiv class=\"row\"\u003E\u003Ctable class=\"card plans-v2-table plans-v2-table-individual\"\u003E";
pug_mixins["plans_v2_table"]('monthly', interstitialPaymentConfig);
pug_html = pug_html + "\u003C\u002Ftable\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"row plans-v2-table-container\" hidden data-ol-plans-v2-period=\"annual\"\u003E\u003Cdiv class=\"col-sm-12\"\u003E\u003Cdiv class=\"row\"\u003E\u003Ctable class=\"card plans-v2-table plans-v2-table-individual\"\u003E";
pug_mixins["plans_v2_table"]('annual', interstitialPaymentConfig);
pug_html = pug_html + "\u003C\u002Ftable\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
if ((showCurrencyAndPaymentMethods)) {
pug_mixins["currency_and_payment_methods"]();
}
pug_html = pug_html + "\u003Cdiv class=\"invisible\" aria-hidden=\"true\" data-ol-plans-v2-table-sticky-header-stop\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
if ((showSkipLink)) {
pug_html = pug_html + "\u003Cdiv class=\"row row-spaced-small text-center\"\u003E\u003Ca" + (pug.attr("href", skipLinkTarget, true, true)+" event-tracking=\"skip-button-click\" event-tracking-mb=\"true\" event-tracking-trigger=\"click\" event-segmentation=\"{&quot;location&quot;: &quot;interstitial-page&quot;}\"") + "\u003E" + (pug.escape(null == (pug_interp = translate("continue_with_free_plan")) ? "" : pug_interp)) + "\t\t\t\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E";
}
pug_html = pug_html + ("\u003C\u002Fmain\u003E" + (null == (pug_interp = moduleIncludes("contactModalGeneral-marketing", locals)) ? "" : pug_interp));
