...
pug_html = pug_html + "\u003Cmain class=\"content content-alt\" id=\"main-content\" data-ol-captcha-retry-trigger-area=\"\"\u003E\u003Cdiv class=\"container\"\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-sm-12 col-md-6 col-md-offset-3\"\u003E\u003Cdiv class=\"card\"\u003E\u003Ch1 class=\"card-header text-capitalize\"\u003E" + (pug.escape(null == (pug_interp = translate("reconfirm")) ? "" : pug_interp)) + " " + (pug.escape(null == (pug_interp = translate("Account")) ? "" : pug_interp)) + "\u003C\u002Fh1\u003E\u003Cp\u003E" + (pug.escape(null == (pug_interp = translate('reconfirm_explained')) ? "" : pug_interp)) + "&nbsp;\u003Ca" + (pug.attr("href", `mailto:${settings.adminEmail}`, true, true)) + "\u003E" + (pug.escape(null == (pug_interp = settings.adminEmail) ? "" : pug_interp)) + "\u003C\u002Fa\u003E.\u003C\u002Fp\u003E\u003Cform" + (pug.attr("data-ol-async-form", true, true, true)+" name=\"reconfirmAccountForm\" action=\"\u002Fuser\u002Freconfirm\" method=\"POST\""+pug.attr("aria-label", translate('request_reconfirmation_email'), true, true)+pug.attr("captcha", (showCaptcha ? '' : false), true, true)+pug.attr("captcha-action-name", (showCaptcha ? "passwordReset" : false), true, true)) + "\u003E\u003Cdiv data-ol-not-sent\u003E";
pug_mixins["formMessages"]();
pug_html = pug_html + "\u003Cinput" + (" type=\"hidden\" name=\"_csrf\""+pug.attr("value", csrfToken, true, true)) + "\u003E\u003Cdiv class=\"form-group\"\u003E\u003Clabel for=\"email\"\u003E" + (pug.escape(null == (pug_interp = translate("please_enter_email")) ? "" : pug_interp)) + "\u003C\u002Flabel\u003E\u003Cinput" + (" class=\"form-control\""+" aria-label=\"email\" type=\"email\" name=\"email\" placeholder=\"email@example.com\""+pug.attr("required", true, true, true)+pug.attr("autofocus", true, true, true)+pug.attr("value", email, true, true)) + "\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"actions\"\u003E\u003Cbutton" + (" class=\"btn btn-primary\""+" type=\"submit\""+pug.attr("data-ol-disabled-inflight", true, true, true)+pug.attr("aria-label", translate('request_password_reset_to_reconfirm'), true, true)) + "\u003E\u003Cspan data-ol-inflight=\"idle\"\u003E" + (pug.escape(null == (pug_interp = translate('request_password_reset_to_reconfirm')) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cspan hidden data-ol-inflight=\"pending\"\u003E" + (pug.escape(null == (pug_interp = translate('request_password_reset_to_reconfirm')) ? "" : pug_interp)) + "… \u003C\u002Fspan\u003E\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv hidden data-ol-sent\u003E\u003Cdiv class=\"alert alert-success\" role=\"alert\" aria-live=\"polite\"\u003E\u003Cspan\u003E" + (pug.escape(null == (pug_interp = translate('password_reset_email_sent')) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fform\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-sm-12 col-md-6 col-md-offset-3\"\u003E";
if (showCaptcha) {
pug_mixins["recaptchaConditions"]();
}
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fmain\u003E";
...
pug_html = pug_html + "\u003Cscript" + (" type=\"text\u002Fjavascript\""+pug.attr("nonce", scriptNonce, true, true)) + "\u003Ewindow.addEventListener('DOMContentLoaded', function() {\n\t\u002F\u002F- Look for bundle\n\tvar cdnBlocked = typeof Frontend === 'undefined'\n\t\u002F\u002F- Prevent loops\n\tvar noCdnAlreadyInUrl = window.location.href.indexOf(\"nocdn=true\") != -1\n\tif (cdnBlocked && !noCdnAlreadyInUrl && navigator.userAgent.indexOf(\"Googlebot\") == -1) {\n\t\t\u002F\u002F- Set query param, server will not set CDN url\n\t\twindow.location.search += \"&nocdn=true\";\n\t}\n})\u003C\u002Fscript\u003E\u003C\u002Fhtml\u003E";
        ...
        typeof projectDashboardReact !== 'undefined' ? projectDashboardReact : undefined, "reconfirm_email" in locals_for_with ?
        locals_for_with.reconfirm_email :
        typeof reconfirm_email !== 'undefined' ? reconfirm_email : undefined, "scriptNonce" in locals_for_with ?
