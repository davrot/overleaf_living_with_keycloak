...
pug_html = pug_html + "\u003Cscript" + (" type=\"text\u002Fjavascript\""+pug.attr("nonce", scriptNonce, true, true)+pug.attr("src", (wsUrl || '/socket.io') + '/socket.io.js', true, true)) + "\u003E\u003C\u002Fscript\u003E\u003Cdiv class=\"content content-alt\" id=\"main-content\"\u003E\u003Cdiv class=\"container\"\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-md-8 col-md-offset-2\"\u003E\u003Cdiv class=\"card launchpad-body\"\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-md-12\"\u003E\u003Cdiv class=\"text-center\"\u003E\u003Ch1\u003E" + (pug.escape(null == (pug_interp = translate('welcome_to_sl')) ? "" : pug_interp)) + "\u003C\u002Fh1\u003E\u003Cp\u003E\u003Cimg" + (pug.attr("src", buildImgPath('/ol-brand/overleaf-o.svg'), true, true)) + "\u003E\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C!-- wrapper --\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-md-8 col-md-offset-2\"\u003E\u003C!-- create first admin form --\u003E";
if (!adminUserExists) {
pug_html = pug_html + "\u003Cdiv class=\"row\" data-ol-not-sent\u003E\u003Cdiv class=\"col-md-12\"\u003E\u003Ch2\u003E" + (pug.escape(null == (pug_interp = translate('create_first_admin_account')) ? "" : pug_interp)) + "\u003C\u002Fh2\u003E\u003C!-- Local Auth Form--\u003E";
if (authMethod === 'local') {
pug_html = pug_html + "\u003Cform data-ol-async-form data-ol-register-admin action=\"\u002Flaunchpad\u002Fregister_admin\" method=\"POST\"\u003E\u003Cinput" + (" name=\"_csrf\" type=\"hidden\""+pug.attr("value", csrfToken, true, true)) + "\u003E";
pug_mixins["formMessages"]();
...
pug_html = pug_html + "\u003C!-- Ldap Form--\u003E";
if (authMethod === 'ldap') {
pug_html = pug_html + "\u003Ch3\u003E" + (pug.escape(null == (pug_interp = translate('ldap')) ? "" : pug_interp)) + "\u003C\u002Fh3\u003E\u003Cp\u003E" + (pug.escape(null == (pug_interp = translate('ldap_create_admin_instructions')) ? "" : pug_interp)) + "\u003C\u002Fp\u003E\u003Cform data-ol-async-form data-ol-register-admin action=\"\u002Flaunchpad\u002Fregister_ldap_admin\" method=\"POST\"\u003E\u003Cinput" + (" name=\"_csrf\" type=\"hidden\""+pug.attr("value", csrfToken, true, true)) + "\u003E";
pug_mixins["formMessages"]();
pug_html = pug_html + "\u003Cdiv class=\"form-group\"\u003E\u003Clabel for=\"email\"\u003E" + (pug.escape(null == (pug_interp = translate("email")) ? "" : pug_interp)) + "\u003C\u002Flabel\u003E\u003Cinput class=\"form-control\" type=\"email\" name=\"email\" placeholder=\"email@example.com\" autocomplete=\"username\" required autofocus=\"true\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"actions\"\u003E\u003Cbutton class=\"btn-primary btn\" type=\"submit\" data-ol-disabled-inflight\u003E\u003Cspan data-ol-inflight=\"idle\"\u003E" + (pug.escape(null == (pug_interp = translate("register")) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cspan hidden data-ol-inflight=\"pending\"\u003E" + (pug.escape(null == (pug_interp = translate("registering")) ? "" : pug_interp)) + "…\u003C\u002Fspan\u003E\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003C\u002Fform\u003E";
}
pug_html = pug_html + "\u003C!-- Saml Form--\u003E";
if (authMethod === 'saml') {
pug_html = pug_html + "\u003Ch3\u003E" + (pug.escape(null == (pug_interp = translate('saml')) ? "" : pug_interp)) + "\u003C\u002Fh3\u003E\u003Cp\u003E" + (pug.escape(null == (pug_interp = translate('saml_create_admin_instructions')) ? "" : pug_interp)) + "\u003C\u002Fp\u003E\u003Cform data-ol-async-form data-ol-register-admin action=\"\u002Flaunchpad\u002Fregister_saml_admin\" method=\"POST\"\u003E\u003Cinput" + (" name=\"_csrf\" type=\"hidden\""+pug.attr("value", csrfToken, true, true)) + "\u003E";
pug_mixins["formMessages"]();
pug_html = pug_html + "\u003Cdiv class=\"form-group\"\u003E\u003Clabel for=\"email\"\u003E" + (pug.escape(null == (pug_interp = translate("email")) ? "" : pug_interp)) + "\u003C\u002Flabel\u003E\u003Cinput class=\"form-control\" type=\"email\" name=\"email\" placeholder=\"email@example.com\" autocomplete=\"username\" required autofocus=\"true\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"actions\"\u003E\u003Cbutton class=\"btn-primary btn\" type=\"submit\" data-ol-disabled-inflight\u003E\u003Cspan data-ol-inflight=\"idle\"\u003E" + (pug.escape(null == (pug_interp = translate("register")) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cspan hidden data-ol-inflight=\"pending\"\u003E" + (pug.escape(null == (pug_interp = translate("registering")) ? "" : pug_interp)) + "…\u003C\u002Fspan\u003E\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003C\u002Fform\u003E";
}
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cbr\u003E";
}
pug_html = pug_html + "\u003C!-- status indicators --\u003E";
if (adminUserExists) {
pug_html = pug_html + "\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-md-12 status-indicators\"\u003E\u003Ch2\u003E" + (pug.escape(null == (pug_interp = translate('status_checks')) ? "" : pug_interp)) + "\u003C\u002Fh2\u003E\u003C!-- websocket --\u003E\u003Cdiv class=\"row row-spaced-small\"\u003E\u003Cdiv class=\"col-sm-5\"\u003E" + (pug.escape(null == (pug_interp = translate('websockets')) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"col-sm-7\"\u003E";
pug_mixins["launchpad-check"]('websocket');
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C!-- break --\u003E\u003Chr class=\"thin\"\u003E\u003C!-- other actions --\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-md-12\"\u003E\u003Ch2\u003E" + (pug.escape(null == (pug_interp = translate('other_actions')) ? "" : pug_interp)) + "\u003C\u002Fh2\u003E\u003Ch3\u003E" + (pug.escape(null == (pug_interp = translate('send_test_email')) ? "" : pug_interp)) + "\u003C\u002Fh3\u003E\u003Cform class=\"form\" data-ol-async-form action=\"\u002Flaunchpad\u002Fsend_test_email\" method=\"POST\"\u003E\u003Cdiv class=\"form-group\"\u003E\u003Clabel for=\"email\"\u003EEmail\u003C\u002Flabel\u003E\u003Cinput class=\"form-control\" type=\"text\" id=\"email\" name=\"email\" required\u003E\u003C\u002Fdiv\u003E\u003Cbutton class=\"btn-primary btn\" type=\"submit\" data-ol-disabled-inflight\u003E\u003Cspan data-ol-inflight=\"idle\"\u003E" + (pug.escape(null == (pug_interp = translate("send")) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cspan hidden data-ol-inflight=\"pending\"\u003E" + (pug.escape(null == (pug_interp = translate("sending")) ? "" : pug_interp)) + "…\u003C\u002Fspan\u003E\u003C\u002Fbutton\u003E\u003Cp\u003E";
pug_mixins["formMessages"]();
pug_html = pug_html + "\u003C\u002Fp\u003E\u003C\u002Fform\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C!-- break --\u003E\u003Chr class=\"thin\"\u003E\u003C!-- Go to app --\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-md-12\"\u003E\u003Cdiv class=\"text-center\"\u003E\u003Cbr\u003E\u003Cp\u003E\u003Ca class=\"btn btn-info\" href=\"\u002Fadmin\"\u003EGo To Admin Panel\u003C\u002Fa\u003E&nbsp;\u003Ca class=\"btn btn-primary\" href=\"\u002Fproject\"\u003EStart Using " + (pug.escape(null == (pug_interp = settings.appName) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003C\u002Fp\u003E\u003Cbr\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
}
...
pug_html = pug_html + "\u003Cscript" + (" type=\"text\u002Fjavascript\""+pug.attr("nonce", scriptNonce, true, true)) + "\u003Ewindow.addEventListener('DOMContentLoaded', function() {\n\t\u002F\u002F- Look for bundle\n\tvar cdnBlocked = typeof Frontend === 'undefined'\n\t\u002F\u002F- Prevent loops\n\tvar noCdnAlreadyInUrl = window.location.href.indexOf(\"nocdn=true\") != -1\n\tif (cdnBlocked && !noCdnAlreadyInUrl && navigator.userAgent.indexOf(\"Googlebot\") == -1) {\n\t\t\u002F\u002F- Set query param, server will not set CDN url\n\t\twindow.location.search += \"&nocdn=true\";\n\t}\n})\u003C\u002Fscript\u003E\u003C\u002Fhtml\u003E";
        ...
        typeof Object !== 'undefined' ? Object : undefined, "adminUserExists" in locals_for_with ?
        locals_for_with.adminUserExists :
        typeof adminUserExists !== 'undefined' ? adminUserExists : undefined, "authMethod" in locals_for_with ?
        locals_for_with.authMethod :
        typeof authMethod !== 'undefined' ? authMethod : undefined, "bootstrap5Override" in locals_for_with ?
