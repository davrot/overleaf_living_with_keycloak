import json
from flask import Flask, render_template, request, Response, send_from_directory, session, redirect
...
keycloak_url: str = "https://overleaf.pip.uni-bremen.de/login/oidc"
app = Flask(__name__)
